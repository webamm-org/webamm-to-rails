    ...
    it 'returns attachment definitions' do
      table_definition = WamlToRails::Definition::Database::Schema.new(
        ...
        columns: [
          ...
          WamlToRails::Definition::Database::Schema::Column.new(name: 'first_name', type: 'string', default: nil, null: false),
          WamlToRails::Definition::Database::Schema::Column.new(name: 'last_name', type: 'string', default: nil, null: false)
        ]
      )
