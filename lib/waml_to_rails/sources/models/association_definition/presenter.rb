      ...
      class AssociationDefinition
        class Presenter
          ...
          def render
            ...
            if @association['class_name'].present?
              assoc_definition << ", class_name: '#{@association['class_name']}'"
            end

            if @association['foreign_key'].present?
              assoc_definition << ", foreign_key: '#{@association['foreign_key']}'"
            end

            if @association['dependent'].present?
              assoc_definition << ", dependent: :#{@association['dependent']}"
            end
