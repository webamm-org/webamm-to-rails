  ...
  module Sources
    module Gemfile
      class Definition
        ...
        def gems
          ::WamlToRails::Sources::Gemfile::ProjectSet.new(waml_definition: @waml_definition).collection.map do |gem|
            ::WamlToRails::Sources::Gemfile::GemDefinition::Presenter.new(gem: gem).render
